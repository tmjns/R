...
Before I dig deeper into project details, I want to give proper respect to <a href="https://buck.co/">Buck</a> for the main inspiration. For this, I experimented with the Google Chrome Web Serial API and build my on ring-based interface. 
...
## Links
Web Serial API : https://developer.mozilla.org/en-US/docs/Web/API/Web_Serial_API <br>
